...
const MenuItem = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      >
        {item.svg}
        <span className="sr-only group-hover:not-sr-only group-hover:ml-3 transition-opacity duration-200 ease-in-out">
          {item.name}
        </span>
      </a>
    </motion.div>
...
const Sidebar = () => {
  ...
  return (
    <motion.aside
      ...
      initial={{ x: -88 }}
      animate={{ x: 0 }}
      className="hidden sm:flex sm:flex-col bg-gray-200 hover:w-56 w-20 transition-all duration-200 ease-in-out group"
    ...
    >
      ...
      >
        ...
        <span className="hidden group-hover:inline-block ml-2 font-bold text-white">
          Mini CRM
        </span>
      </a>
